document.addEventListener("DOMContentLoaded", () => {
  ...
  // ---- MODULE LIST ----
  // Replace IDs/titles to match your real videos. These are examples you gave earlier.
  const MODULES = [
    { id: "5C_0X6G4ytI", title: "Vehicle Inspection (Pre-Trip)" },
    { id: "qZkkgkMLsvI", title: "Basic Control Skills" },
    { id: "-deVMu0kyik", title: "On-Road Driving" }
  ];
